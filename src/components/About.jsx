    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-15 pt-22 relative z-10 bg-gradient-to-br from-slate-50 via-purple-50 to-green-100">
      <div className="grid grid-cols-1  ">
        <div className="text-center">
          ...
          >
            My journey in web development has been driven by a personal passion
            to learn. I have independently acquired a diverse skill set and have
            a strong passion for building engaging digital experiences.
          </motion.p>
        </div>
      </div>
    </div>
